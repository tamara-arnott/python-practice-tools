          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <textarea
                ...
                className="w-full p-4 font-mono text-sm border-2 border-gray-200 rounded-lg focus:border-lime-500 focus:ring-2 focus:ring-lime-200 transition-all resize-y"
